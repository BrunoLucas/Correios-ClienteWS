    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(br.com.rukaso.correios.soap.CalcPrecoPrazoWS.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.rukaso.correios.soap.CalcPrecoPrazoWS.class.getResource(".");
